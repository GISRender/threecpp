...
// specialise Matrix_implementaiton to be TCMatrixf
#define  Matrix_implementation TCMatrixf
...
TCMatrixf::TCMatrixf( const TCMatrixd& mat )
{
    set(mat.ptr());
}

TCMatrixf& TCMatrixf::operator = (const TCMatrixd& rhs)
{
    set(rhs.ptr());
    return *this;
}

void TCMatrixf::set(const TCMatrixd& rhs)
{
    set(rhs.ptr());
}
...
void Matrix_implementation::setRotate(const TCQuat& q)
{
...
TCQuat Matrix_implementation::getRotate() const
{
    TCQuat q;
...
TCQuat Matrix_implementation::getRotate() const
{
    ...
    // From http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToTCQuaternion/index.htm
...
void Matrix_implementation::setTrans( const TCVec3f& v )
{
    _mat[3][0] = v[0];
    _mat[3][1] = v[1];
    _mat[3][2] = v[2];
}
void Matrix_implementation::setTrans( const TCVec3d& v )
{
    _mat[3][0] = v[0];
    _mat[3][1] = v[1];
    _mat[3][2] = v[2];
...
void Matrix_implementation::makeScale( const TCVec3f& v )
{
    makeScale(v[0], v[1], v[2] );
}

void Matrix_implementation::makeScale( const TCVec3d& v )
{
    makeScale(v[0], v[1], v[2] );
}
...
void Matrix_implementation::makeTranslate( const TCVec3f& v )
{
    makeTranslate( v[0], v[1], v[2] );
}

void Matrix_implementation::makeTranslate( const TCVec3d& v )
{
    makeTranslate( v[0], v[1], v[2] );
}
...
void Matrix_implementation::makeRotate( const TCVec3f& from, const TCVec3f& to )
{
    makeIdentity();
...
void Matrix_implementation::makeRotate( const TCVec3d& from, const TCVec3d& to )
{
    makeIdentity();
...
void Matrix_implementation::makeRotate( value_type angle, const TCVec3f& axis )
{
    makeIdentity();
...
void Matrix_implementation::makeRotate( value_type angle, const TCVec3d& axis )
{
    makeIdentity();
...
void Matrix_implementation::makeRotate( const TCQuat& TCQuat )
{
    makeIdentity();
...
void Matrix_implementation::makeRotate( value_type angle1, const TCVec3f& axis1,
...
void Matrix_implementation::makeRotate( value_type angle1, const TCVec3d& axis1,
...
void Matrix_implementation::makeLookAt(const TCVec3d& eye,const TCVec3d& center,const TCVec3d& up)
{
...
void Matrix_implementation::getLookAt(TCVec3f& eye,TCVec3f& center,TCVec3f& up,value_type lookDistance) const
{
...
void Matrix_implementation::getLookAt(TCVec3d& eye,TCVec3d& center,TCVec3d& up,value_type lookDistance) const
{
    Matrix_implementation inv;
    inv.invert(*this);
